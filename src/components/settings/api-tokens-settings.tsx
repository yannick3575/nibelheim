...
import { CreateTokenDialog } from '@/app/(dashboard)/settings/api-tokens/components/create-token-dialog';
import { RevokeTokenDialog } from '@/app/(dashboard)/settings/api-tokens/components/revoke-token-dialog';
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Pour automatiser Tech Watch avec Claude Chrome ou vos propres scripts
                    </p>
                </div>
                ...
                <Card>
                    <CardContent className="py-12 text-center">
                        ...
                        <p className="text-muted-foreground mb-4">
                            Créez votre premier token pour automatiser Tech Watch
                        </p>
                        <Button onClick={() => setCreateDialogOpen(true)}>
                            <Plus className="h-4 w-4 mr-2" />
                            Créer un token
